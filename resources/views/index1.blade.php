            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    <div class="content-wthree">
                        <h2>Login Now</h2>
                        <p>Log In Now! Many things you  should know! </p>
                        <?php echo $msg; ?>
                        <form>
                            ...
                            <button name="submit" formaction="/welcome" class="btn" type="submit">Login</button>
                           
                        </form>
                        <div class="social-icons">
                            <p>Create Account! <a href="/r">Register</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
