...
<section style="padding-bottom: 70px;">
    <CENTER>
      <p style="padding-bottom: 90px;"><u style="color: red;"><b style="color: red;">BY & SELL</b></u></p>
      ...
      <h1 style="padding-top: 50px;">Currencies offered BY:<b style="color: red;"> USD</b> <b style="color: rgb(255, 123, 0);">GBP</b> <b style="color: blue;">EURO</b></h1>
        <div id="banner1"></div>
