        ...
        $code = mysqli_real_escape_string($conn, md5(rand()));
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'walidkinaan2002@gmail.com';                     //SMTP username
                        $mail->Password   = 'Iamagoodman';                               //SMTP password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                        //Recipients
                        $mail->setFrom('walidkinaan2002@gmail.com');
                        $mail->addAddress($email);

                        //Content
                        $mail->isHTML(true);                                  //Set email format to HTML
                        $mail->Subject = 'no reply';
                        $mail->Body    = 'Here is the verification link <b><a href="http://localhost/index1/?verification='.$code.'">http://localhost/index1/?verification='.$code.'</a></b>';
